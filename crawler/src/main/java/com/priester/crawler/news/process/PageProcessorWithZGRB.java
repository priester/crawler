...
//		
		page.addTargetRequests(
				page.getHtml().links().regex("http://cnews.chinadaily.com.cn/....-../../content_[0-9]{8}.htm").all());
...
//			System.out.println(StripHtmlUtil.stripHtml(page.getHtml().xpath("//[@class='TRS_Editor']/table/tbody/tr/td").toString()));
			String content = StripHtmlUtil.stripHtml(StripHtmlUtil.stripHtml(page.getHtml().xpath("//[@class='arcBox']").toString()));
...
//					JdbcProcess.save(news);
	...
	public static void main(String[] args) {
		...
		Spider.create(new PageProcessorWithZGRB()).addUrl("http://cnews.chinadaily.com.cn/node_1132703.htm")
				.thread(1).run();
